...
http_archive(
    ...
    sha256 = "2a526438878a48f88dfae17d29362eea61e86df42bb1daf0d9d6145bcfdc7782",
    strip_prefix = "protobuf-3.22.4",
    urls = ["https://github.com/protocolbuffers/protobuf/archive/v3.22.4.tar.gz"],
)
