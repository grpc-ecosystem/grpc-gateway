...
type Registry struct {
	...
	// ignoreAdditionalBindings controls whether to ignore additional bindings when generating the OpenAPI spec.
...
func (r *Registry) SetIgnoreAdditionalBindings(ignore bool) {
	r.ignoreAdditionalBindings = ignore
}
...
func (r *Registry) IsIgnoreAdditionalBindings() bool {
	return r.ignoreAdditionalBindings
}
