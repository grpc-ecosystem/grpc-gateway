...
func (*EmptyProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_flow_combination_4026ea65f3b791e2, []int{0}
}
...
func (*NonEmptyProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_flow_combination_4026ea65f3b791e2, []int{1}
}
...
func (*UnaryProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_flow_combination_4026ea65f3b791e2, []int{2}
}
...
func (*NestedProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_flow_combination_4026ea65f3b791e2, []int{3}
}
...
func (*SingleNestedProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_flow_combination_4026ea65f3b791e2, []int{4}
}
...
func init() {
	proto.RegisterFile("examples/proto/examplepb/flow_combination.proto", fileDescriptor_flow_combination_4026ea65f3b791e2)
}

var fileDescriptor_flow_combination_4026ea65f3b791e2 = []byte{
