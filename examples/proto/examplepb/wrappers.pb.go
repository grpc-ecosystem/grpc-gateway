...
func (*Wrappers) Descriptor() ([]byte, []int) {
	return fileDescriptor_aa1e7ec5682437b9, []int{0}
}
...
func init() {
	proto.RegisterFile("examples/proto/examplepb/wrappers.proto", fileDescriptor_aa1e7ec5682437b9)
}

var fileDescriptor_aa1e7ec5682437b9 = []byte{
