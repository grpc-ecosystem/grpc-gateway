...
type WalletSolidityClient interface {
	...
	TotalTransaction(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*NumberMessage, error)
	GetTransactionById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*protocol1.Transaction, error)
	GetTransactionsByTimestamp(ctx context.Context, in *TimePaginatedMessage, opts ...grpc.CallOption) (*TransactionList, error)
	GetTransactionsByTimestampCount(ctx context.Context, in *TimeMessage, opts ...grpc.CallOption) (*NumberMessage, error)
	...
	GetTransactionsFromThisCount(ctx context.Context, in *protocol1.Account, opts ...grpc.CallOption) (*NumberMessage, error)
	GetTransactionsToThisCount(ctx context.Context, in *protocol1.Account, opts ...grpc.CallOption) (*NumberMessage, error)
}
...
func (c *walletSolidityClient) GetTransactionsByTimestamp(ctx context.Context, in *TimePaginatedMessage, opts ...grpc.CallOption) (*TransactionList, error) {
...
func (c *walletSolidityClient) GetTransactionsByTimestampCount(ctx context.Context, in *TimeMessage, opts ...grpc.CallOption) (*NumberMessage, error) {
	out := new(NumberMessage)
	err := grpc.Invoke(ctx, "/protocol.WalletSolidity/GetTransactionsByTimestampCount", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletSolidityClient) GetTransactionsFromThis(ctx context.Context, in *AccountPaginated, opts ...grpc.CallOption) (*TransactionList, error) {
	out := new(TransactionList)
...
func (c *walletSolidityClient) GetTransactionsToThis(ctx context.Context, in *AccountPaginated, opts ...grpc.CallOption) (*TransactionList, error) {
	out := new(TransactionList)
...
func (c *walletSolidityClient) GetTransactionsFromThisCount(ctx context.Context, in *protocol1.Account, opts ...grpc.CallOption) (*NumberMessage, error) {
	out := new(NumberMessage)
	err := grpc.Invoke(ctx, "/protocol.WalletSolidity/GetTransactionsFromThisCount", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletSolidityClient) GetTransactionsToThisCount(ctx context.Context, in *protocol1.Account, opts ...grpc.CallOption) (*NumberMessage, error) {
	out := new(NumberMessage)
	err := grpc.Invoke(ctx, "/protocol.WalletSolidity/GetTransactionsToThisCount", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WalletSolidityServer interface {
	...
	TotalTransaction(context.Context, *EmptyMessage) (*NumberMessage, error)
	GetTransactionById(context.Context, *BytesMessage) (*protocol1.Transaction, error)
	GetTransactionsByTimestamp(context.Context, *TimePaginatedMessage) (*TransactionList, error)
	GetTransactionsByTimestampCount(context.Context, *TimeMessage) (*NumberMessage, error)
	...
	GetTransactionsFromThisCount(context.Context, *protocol1.Account) (*NumberMessage, error)
	GetTransactionsToThisCount(context.Context, *protocol1.Account) (*NumberMessage, error)
}
...
func _WalletSolidity_GetTransactionsByTimestamp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletSolidityServer).GetTransactionsByTimestamp(ctx, req.(*TimePaginatedMessage))
	}
	return interceptor(ctx, in, info, handler)
}

func _WalletSolidity_GetTransactionsByTimestampCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TimeMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletSolidityServer).GetTransactionsByTimestampCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.WalletSolidity/GetTransactionsByTimestampCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletSolidityServer).GetTransactionsByTimestampCount(ctx, req.(*TimeMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WalletSolidity_GetTransactionsFromThis_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletSolidityServer).GetTransactionsFromThis(ctx, req.(*AccountPaginated))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WalletSolidity_GetTransactionsToThis_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletSolidityServer).GetTransactionsToThis(ctx, req.(*AccountPaginated))
	}
	return interceptor(ctx, in, info, handler)
}

func _WalletSolidity_GetTransactionsFromThisCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(protocol1.Account)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletSolidityServer).GetTransactionsFromThisCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.WalletSolidity/GetTransactionsFromThisCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletSolidityServer).GetTransactionsFromThisCount(ctx, req.(*protocol1.Account))
	}
	return interceptor(ctx, in, info, handler)
}

func _WalletSolidity_GetTransactionsToThisCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(protocol1.Account)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletSolidityServer).GetTransactionsToThisCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.WalletSolidity/GetTransactionsToThisCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletSolidityServer).GetTransactionsToThisCount(ctx, req.(*protocol1.Account))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _WalletSolidity_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTransactionsByTimestampCount",
			Handler:    _WalletSolidity_GetTransactionsByTimestampCount_Handler,
		},
		{
		...
		{
			MethodName: "GetTransactionsFromThisCount",
			Handler:    _WalletSolidity_GetTransactionsFromThisCount_Handler,
		},
		{
			MethodName: "GetTransactionsToThisCount",
			Handler:    _WalletSolidity_GetTransactionsToThisCount_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/api.proto",
...
var fileDescriptor0 = []byte{
	...
	,
}
