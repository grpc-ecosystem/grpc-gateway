...
func (m *ABitOfEverythingServiceDeepPathEchoBody) validateRepeatedStringAnnotation(formats strfmt.Registry) error {
...
func (m *ABitOfEverythingServiceDeepPathEchoBody) UnmarshalBinary(b []byte) error {
	var res ABitOfEverythingServiceDeepPathEchoBody
...
func (m *ABitOfEverythingServiceDeepPathEchoBodySingleNested) validateOk(formats strfmt.Registry) error {
	...
	if m.Ok != nil {
		if err := m.Ok.Validate(formats); err != nil {
			ve := new(errors.Validation)
			if stderrors.As(err, &ve) {
				return ve.ValidateName("singleNested" + "." + "ok")
			}
			ce := new(errors.CompositeError)
			if stderrors.As(err, &ce) {
				return ce.ValidateName("singleNested" + "." + "ok")
			}
...
func (m *ABitOfEverythingServiceDeepPathEchoBodySingleNested) UnmarshalBinary(b []byte) error {
	var res ABitOfEverythingServiceDeepPathEchoBodySingleNested
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
