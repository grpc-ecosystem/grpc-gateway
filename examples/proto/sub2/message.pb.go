...
func (*IdMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_8d5058434f4f209b, []int{0}
}
...
func init() {
	proto.RegisterFile("examples/proto/sub2/message.proto", fileDescriptor_message_8d5058434f4f209b)
}

var fileDescriptor_message_8d5058434f4f209b = []byte{
