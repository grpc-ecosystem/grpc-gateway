...
func (PathEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dfe1d80fc8dac3c4, []int{0}
}
...
func (MessagePathEnum_NestedPathEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dfe1d80fc8dac3c4, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("examples/proto/pathenum/path_enum.proto", fileDescriptor_dfe1d80fc8dac3c4)
}

var fileDescriptor_dfe1d80fc8dac3c4 = []byte{
