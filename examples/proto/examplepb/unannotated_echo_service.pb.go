...
func (*UnannotatedSimpleMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_unannotated_echo_service_2965fc76f23d12bd, []int{0}
}
...
func init() {
	proto.RegisterFile("examples/proto/examplepb/unannotated_echo_service.proto", fileDescriptor_unannotated_echo_service_2965fc76f23d12bd)
}

var fileDescriptor_unannotated_echo_service_2965fc76f23d12bd = []byte{
