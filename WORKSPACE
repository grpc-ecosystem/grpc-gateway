...
http_archive(
    ...
    strip_prefix = "protobuf-3.22.3",
    urls = ["https://github.com/protocolbuffers/protobuf/archive/v3.22.3.tar.gz"],
)
...
http_archive(
    ...
    urls = ["https://github.com/bazelbuild/buildtools/archive/6.1.0.tar.gz"],
)
