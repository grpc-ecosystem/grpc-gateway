...
http_archive(
    ...
    strip_prefix = "googleapis-27c16bba0a5cebc6deddbe6d5d9456355c55fb49",
    urls = [
        "https://github.com/googleapis/googleapis/archive/27c16bba0a5cebc6deddbe6d5d9456355c55fb49.zip",
    ],
)
