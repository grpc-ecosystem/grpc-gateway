...
type Document struct {
	...
	xxx_hidden_Info         *Info                      `protobuf:"bytes,1,opt,name=info,proto3" json:"info,omitempty"`
	xxx_hidden_Servers      *[]*Server                 `protobuf:"bytes,2,rep,name=servers,proto3" json:"servers,omitempty"`
	xxx_hidden_ExternalDocs *ExternalDocs              `protobuf:"bytes,3,opt,name=external_docs,json=externalDocs,proto3" json:"external_docs,omitempty"`
	xxx_hidden_Tags         *[]*Tag                    `protobuf:"bytes,4,rep,name=tags,proto3" json:"tags,omitempty"`
...
func (x *Document) SetExtensions(v map[string]*structpb.Value) {
...
type Document_builder struct {
	...
	Tags []*Tag
	// Custom specification extensions rendered at the root of the OpenAPI
	// document. Keys MUST start with "x-".
	//
...
type Info_builder struct {
	...
	Version string
	// Custom specification extensions rendered on the Info object. Keys MUST
	// start with "x-".
	//
	// See: https://spec.openapis.org/oas/v3.1.0#specification-extensions
	Extensions map[string]*structpb.Value
...
func (x *License) GetIdentifier() string {
	if x != nil {
		if x, ok := x.xxx_hidden_Source.(*license_Identifier); ok {
			return x.Identifier
		}
	}
	return ""
...
func (x *License) SetIdentifier(v string) {
	x.xxx_hidden_Source = &license_Identifier{v}
}
...
func (x *License) HasIdentifier() bool {
	...
	_, ok := x.xxx_hidden_Source.(*license_Identifier)
	return ok
}
...
func (x *License) ClearIdentifier() {
	if _, ok := x.xxx_hidden_Source.(*license_Identifier); ok {
		x.xxx_hidden_Source = nil
	}
}
...
func (b0 License_builder) Build() *License {
	...
	x.xxx_hidden_Name = b.Name
	if b.Identifier != nil {
		x.xxx_hidden_Source = &license_Identifier{*b.Identifier}
	}
	if b.Url != nil {
...
type Operation struct {
	...
	xxx_hidden_Summary      string                     `protobuf:"bytes,2,opt,name=summary,proto3" json:"summary,omitempty"`
	xxx_hidden_Description  string                     `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`
	xxx_hidden_ExternalDocs *ExternalDocs              `protobuf:"bytes,4,opt,name=external_docs,json=externalDocs,proto3" json:"external_docs,omitempty"`
	xxx_hidden_OperationId  string                     `protobuf:"bytes,5,opt,name=operation_id,json=operationId,proto3" json:"operation_id,omitempty"`
	xxx_hidden_Deprecated   bool                       `protobuf:"varint,6,opt,name=deprecated,proto3" json:"deprecated,omitempty"`
	xxx_hidden_Servers      *[]*Server                 `protobuf:"bytes,7,rep,name=servers,proto3" json:"servers,omitempty"`
	xxx_hidden_Extensions   map[string]*structpb.Value `protobuf:"bytes,8,rep,name=extensions,proto3" json:"extensions,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
type Operation_builder struct {
	...
	Servers []*Server
	// Custom specification extensions rendered on the Operation object. Keys
	// MUST start with "x-".
	//
	// See: https://spec.openapis.org/oas/v3.1.0#specification-extensions
	Extensions map[string]*structpb.Value
...
type Schema_builder struct {
	...
	Deprecated bool
	// Custom specification extensions rendered on the Schema object. Keys
	// MUST start with "x-". Setting this on a field-level annotation forces
	// a schema body (like `title`), so a $ref-typed field carrying extensions
	// is wrapped in `allOf`.
	//
	// See: https://spec.openapis.org/oas/v3.1.0#specification-extensions
	Extensions map[string]*structpb.Value
...
type Tag_builder struct {
	...
	ExternalDocs *ExternalDocs
	// Custom specification extensions rendered on the Tag object. Keys MUST
	// start with "x-".
	//
	// See: https://spec.openapis.org/oas/v3.1.0#specification-extensions
	Extensions map[string]*structpb.Value
...
var file_protoc_gen_openapiv3_options_openapiv3_proto_rawDesc = []byte{
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfa, 0x03, 0x0a, 0x08, 0x44, 0x6f, 0x63, 0x75,
	0x6d, 0x65, 0x6e, 0x74, 0x12, 0x43, 0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20, 0x01,
	...
	0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x49,
	0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x4b, 0x0a, 0x07, 0x73, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x67, 0x72, 0x70,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x52, 0x07, 0x73,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x12, 0x5c, 0x0a, 0x0d, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x5f, 0x64, 0x6f, 0x63, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x37, 0x2e,
	0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76,
	...
	0x44, 0x6f, 0x63, 0x73, 0x12, 0x42, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x04, 0x20, 0x03,
	...
	0x61, 0x67, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x12, 0x63, 0x0a, 0x0a, 0x65, 0x78, 0x74, 0x65,
	0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x43, 0x2e, 0x67,
	...
	0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xf0, 0x03, 0x0a, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x14, 0x0a,
	...
	0x5f, 0x0a, 0x0a, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x08, 0x20,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x45, 0x0a, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x61,
	...
	0x75, 0x72, 0x6c, 0x42, 0x08, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0x3c, 0x0a,
	0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65, 0x73,
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x86, 0x04, 0x0a, 0x09,
	...
	0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x1e, 0x0a, 0x0a, 0x64, 0x65,
	0x70, 0x72, 0x65, 0x63, 0x61, 0x74, 0x65, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a,
	0x64, 0x65, 0x70, 0x72, 0x65, 0x63, 0x61, 0x74, 0x65, 0x64, 0x12, 0x4b, 0x0a, 0x07, 0x73, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x67, 0x72,
	...
	,
	...
	0x72, 0x65, 0x63, 0x61, 0x74, 0x65, 0x64, 0x12, 0x61, 0x0a, 0x0a, 0x65, 0x78, 0x74, 0x65, 0x6e,
	0x73, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x41, 0x2e, 0x67, 0x72,
	0x70, 0x63, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x63, 0x5f, 0x67, 0x65, 0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2e,
	0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x45,
	...
	0x01, 0x22, 0x42, 0x0a, 0x0c, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x44, 0x6f, 0x63,
	...
	0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0xd0, 0x02, 0x0a, 0x03, 0x54, 0x61, 0x67, 0x12, 0x12, 0x0a,
...
var file_protoc_gen_openapiv3_options_openapiv3_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_protoc_gen_openapiv3_options_openapiv3_proto_goTypes = []any{
	...
	nil,                    // 9: grpc.gateway.protoc_gen_openapiv3.options.Document.ExtensionsEntry
	nil,                    // 10: grpc.gateway.protoc_gen_openapiv3.options.Info.ExtensionsEntry
	nil,                    // 11: grpc.gateway.protoc_gen_openapiv3.options.Operation.ExtensionsEntry
	nil,                    // 12: grpc.gateway.protoc_gen_openapiv3.options.Schema.ExtensionsEntry
	nil,                    // 13: grpc.gateway.protoc_gen_openapiv3.options.Tag.ExtensionsEntry
...
var file_protoc_gen_openapiv3_options_openapiv3_proto_depIdxs = []int32{
	...
	9,  // 4: grpc.gateway.protoc_gen_openapiv3.options.Document.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Document.ExtensionsEntry
	2,  // 5: grpc.gateway.protoc_gen_openapiv3.options.Info.contact:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Contact
	3,  // 6: grpc.gateway.protoc_gen_openapiv3.options.Info.license:type_name -> grpc.gateway.protoc_gen_openapiv3.options.License
	10, // 7: grpc.gateway.protoc_gen_openapiv3.options.Info.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Info.ExtensionsEntry
	7,  // 8: grpc.gateway.protoc_gen_openapiv3.options.Operation.external_docs:type_name -> grpc.gateway.protoc_gen_openapiv3.options.ExternalDocs
	4,  // 9: grpc.gateway.protoc_gen_openapiv3.options.Operation.servers:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Server
	11, // 10: grpc.gateway.protoc_gen_openapiv3.options.Operation.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Operation.ExtensionsEntry
	12, // 11: grpc.gateway.protoc_gen_openapiv3.options.Schema.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Schema.ExtensionsEntry
	7,  // 12: grpc.gateway.protoc_gen_openapiv3.options.Tag.external_docs:type_name -> grpc.gateway.protoc_gen_openapiv3.options.ExternalDocs
	13, // 13: grpc.gateway.protoc_gen_openapiv3.options.Tag.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Tag.ExtensionsEntry
	14, // 14: grpc.gateway.protoc_gen_openapiv3.options.Document.ExtensionsEntry.value:type_name -> google.protobuf.Value
	14, // 15: grpc.gateway.protoc_gen_openapiv3.options.Info.ExtensionsEntry.value:type_name -> google.protobuf.Value
	14, // 16: grpc.gateway.protoc_gen_openapiv3.options.Operation.ExtensionsEntry.value:type_name -> google.protobuf.Value
	14, // 17: grpc.gateway.protoc_gen_openapiv3.options.Schema.ExtensionsEntry.value:type_name -> google.protobuf.Value
	14, // 18: grpc.gateway.protoc_gen_openapiv3.options.Tag.ExtensionsEntry.value:type_name -> google.protobuf.Value
