...
//		MsgDescs []*descriptorpb.DescriptorProto
//		Message  string
//		ExpectedParams   []openapiParameterObject
//	}
//
//	tests := []test{
//		{
...
//		return
//	}
//	if want, got := "2.0", result.Openapi; !reflect.DeepEqual(got, want) {
//		t.Errorf("applyTemplate(%#v).Openapi = %s want to be %s", file, got, want)
//	}
