...
http_archive(
    ...
    strip_prefix = "googleapis-27ffde22e73154260f8eaa6115420b7bd895db2f",
    urls = [
        "https://github.com/googleapis/googleapis/archive/27ffde22e73154260f8eaa6115420b7bd895db2f.zip",
    ],
)
