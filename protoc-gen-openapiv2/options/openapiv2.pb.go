...
type JSONSchema struct {
	...
	// Only available in Open API v3, but some tools (like Redoc) support it for v2.
	WriteOnly bool                               `protobuf:"varint,99,opt,name=write_only,json=writeOnly,proto3" json:"write_only,omitempty"`
...
func (x *JSONSchema) GetWriteOnly() bool {
	if x != nil {
		return x.WriteOnly
	}
	return false
...
var file_protoc_gen_openapiv2_options_openapiv2_proto_rawDesc = []byte{
	...
	0x04, 0x10, 0x05, 0x22, 0xf6, 0x0a, 0x0a, 0x0a, 0x4a, 0x53, 0x4f, 0x4e, 0x53, 0x63, 0x68, 0x65,
	...
	0x63, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x77, 0x72, 0x69, 0x74, 0x65, 0x4f, 0x6e, 0x6c, 0x79,
