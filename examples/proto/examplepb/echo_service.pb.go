...
func (*Embedded) Descriptor() ([]byte, []int) {
	return fileDescriptor_echo_service_db3cc2defd36b477, []int{0}
}
...
func (*SimpleMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_echo_service_db3cc2defd36b477, []int{1}
}
...
func init() {
	proto.RegisterFile("examples/proto/examplepb/echo_service.proto", fileDescriptor_echo_service_db3cc2defd36b477)
}

var fileDescriptor_echo_service_db3cc2defd36b477 = []byte{
