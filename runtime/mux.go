...
// keys (as specified by the IANA, e.g: Accept, Cookie, Host) to gRPC context with grpcgateway- prefix. If you want to know support permanent HTTP header enum value,you can view isPermanentHTTPHeader function.
