...
http_archive(
    name = "googleapis",
    sha256 = "d304675334135f8fd9d1dcbef47ffafaf547c6e61121202f0732ff5498cb051e",
    strip_prefix = "googleapis-afb6d4b368b78cfeaf7d1aac0c3fc1564865fc33",
    urls = [
        "https://github.com/googleapis/googleapis/archive/afb6d4b368b78cfeaf7d1aac0c3fc1564865fc33.zip",
    ],
)
...
http_archive(
    name = "bazel_gazelle",
    sha256 = "7b60804432bc7ee9b7a81c9c8c41233eb4145739881de24f6da02062eb13478b",
    urls = [
        "https://mirror.bazel.build/github.com/bazelbuild/bazel-gazelle/releases/download/v0.49.0/bazel-gazelle-v0.49.0.tar.gz",
        "https://github.com/bazelbuild/bazel-gazelle/releases/download/v0.49.0/bazel-gazelle-v0.49.0.tar.gz",
    ],
)
