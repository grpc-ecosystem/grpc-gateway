...
func (a *EchoServiceApiService) EchoServiceEcho2(ctx context.Context, id, num string, localVarOptionals *EchoServiceEcho2Opts) (ExamplepbSimpleMessage, *http.Response, error) {
	var (
...
func (a *EchoServiceApiService) EchoServiceEcho3(ctx context.Context, id, num, lang string, localVarOptionals *EchoServiceEcho3Opts) (ExamplepbSimpleMessage, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *EchoServiceApiService) EchoServiceEcho4(ctx context.Context, id, lineNum, statusNote string, localVarOptionals *EchoServiceEcho4Opts) (ExamplepbSimpleMessage, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
