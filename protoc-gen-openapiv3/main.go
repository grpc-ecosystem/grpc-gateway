...
var (
	...
	ignoreAdditionalBindings       = flag.Bool("ignore_additional_bindings", false, "if set, ignores additional bindings when generating the OpenAPI spec")
	...
	openAPINamingStrategy          = flag.String("openapi_naming_strategy", "fqn", "use the given OpenAPI naming strategy. Allowed values are `fqn` and `simple`.")
...
func main() {
	...
	reg.SetIgnoreAdditionalBindings(*ignoreAdditionalBindings)
