...
type ABitOfEverythingServiceCustom1Params struct {
	SingleNested        *GrpcGatewayExamplesInternalProtoExamplepbABitOfEverythingNested   `form:"singleNested,omitempty" json:"singleNested,omitempty"`
	Uuid                *string                                                            `form:"uuid,omitempty" json:"uuid,omitempty"`
	Nested              *[]GrpcGatewayExamplesInternalProtoExamplepbABitOfEverythingNested `form:"nested,omitempty" json:"nested,omitempty"`
	...
	// MapValue map of numeric enum
	MapValue *map[string]GrpcGatewayExamplesInternalProtoExamplepbNumericEnum `form:"mapValue,omitempty" json:"mapValue,omitempty"`

	// MappedStringValue map of string  (This comment is overridden by the field annotation)
	MappedStringValue        *map[string]string                                                          `form:"mappedStringValue,omitempty" json:"mappedStringValue,omitempty"`
	MappedNestedValue        *map[string]GrpcGatewayExamplesInternalProtoExamplepbABitOfEverythingNested `form:"mappedNestedValue,omitempty" json:"mappedNestedValue,omitempty"`
	...
	// RepeatedNestedAnnotation repeated nested object comment (This comment is overridden by the field annotation)
	RepeatedNestedAnnotation *[]GrpcGatewayExamplesInternalProtoExamplepbABitOfEverythingNested `form:"repeatedNestedAnnotation,omitempty" json:"repeatedNestedAnnotation,omitempty"`

	// NestedAnnotation nested object comments (This comment is overridden by the field annotation)
	NestedAnnotation  *GrpcGatewayExamplesInternalProtoExamplepbABitOfEverythingNested `form:"nestedAnnotation,omitempty" json:"nestedAnnotation,omitempty"`
...
func NewABitOfEverythingServiceCustom1Request(server string, optionalStringValue string, params *ABitOfEverythingServiceCustom1Params) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.SingleNested != nil {

			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "singleNested", *params.SingleNested, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "object", Format: ""}); err != nil {
				return nil, err
		...
		if params.Nested != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "nested", *params.Nested, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "array", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.MapValue != nil {

			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "mapValue", *params.MapValue, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "object", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.MappedStringValue != nil {

			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "mappedStringValue", *params.MappedStringValue, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "object", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.MappedNestedValue != nil {

			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "mappedNestedValue", *params.MappedNestedValue, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "object", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.RepeatedNestedAnnotation != nil {

			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "repeatedNestedAnnotation", *params.RepeatedNestedAnnotation, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "array", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.NestedAnnotation != nil {

			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "nestedAnnotation", *params.NestedAnnotation, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "object", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
