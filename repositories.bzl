...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:6CNJhTjMzgaeaH8WhshcsZNPIvRemiOcFpU7seO/y7Q=",
        version = "v2.6.1",
    )
    go_repository(
