...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:k2lDxrGoSAJRdhFG2tONKMpkizY/4X1cciSdtzk4Jjo=",
        version = "v0.29.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:5zRca5jw7lzVREKCZVNBpysDNBjj74rBh0N2BGQbSR0=",
        version = "v2.4.2",
    )
    go_repository(
        name = "com_github_go_openapi_testify_v2",
        importpath = "github.com/go-openapi/testify/v2",
        sum = "h1:tiByHpvE9uHrrKjOszax7ZvKB7QOgizBWGBLuq0ePx4=",
        version = "v2.4.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:yOzSCGPx+cp5VO7IxvZ9SBFF7j1tZVcNtlHR2iYKtVo=",
        version = "v0.0.0-20260427160629-7cedc36a6bc4",
    )
    go_repository(
        name = "org_golang_google_genproto_googleapis_rpc",
        importpath = "google.golang.org/genproto/googleapis/rpc",
        sum = "h1:tEkOQcXgF6dH1G+MVKZrfpYvozGrzb91k6ha7jireSM=",
        version = "v0.0.0-20260427160629-7cedc36a6bc4",
    )
    go_repository(
