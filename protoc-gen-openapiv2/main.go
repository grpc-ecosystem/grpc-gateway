...
var (
	...
	doNotSetEnumDefaultValue       = flag.Bool("do_not_set_enum_default_value", false, "if true, default enum value is not set")
...
func main() {
	...
	reg.SetDoNotSetEnumDefaultValue(*doNotSetEnumDefaultValue)
