 ...
 * @param optional nil or *ABitOfEverythingApiABitOfEverythingServiceCheckGetQueryParamsOpts - Optional Parameters:
     ...
     * @param "MapValue" (optional.Interface of Object) -  map of numeric enum
     * @param "MappedStringValue" (optional.String) -  Map of string title  Map of string description.
     * @param "MappedNestedValue" (optional.Interface of Object) - 
...
func (a *ABitOfEverythingApiService) ABitOfEverythingServiceCreateBook(ctx context.Context, body ExamplepbBook, parent string, localVarOptionals *ABitOfEverythingApiABitOfEverythingServiceCreateBookOpts) (ExamplepbBook, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ExamplepbABitOfEverything
*/
func (a *ABitOfEverythingApiService) ABitOfEverythingServiceDeepPathEcho(ctx context.Context, body ABitOfEverythingServiceDeepPathEchoBody, singleNestedName string) (ExamplepbABitOfEverything, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return interface{}
*/
func (a *ABitOfEverythingApiService) ABitOfEverythingServiceGetMessageWithBody(ctx context.Context, body ExamplepbBody, id string) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return interface{}
*/
func (a *ABitOfEverythingApiService) ABitOfEverythingServicePostOneofEnum(ctx context.Context, body string) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return interface{}
*/
func (a *ABitOfEverythingApiService) ABitOfEverythingServicePostWithEmptyBody(ctx context.Context, body ABitOfEverythingServicePostWithEmptyBodyBody, name string) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return interface{}
*/
func (a *ABitOfEverythingApiService) ABitOfEverythingServiceUpdate(ctx context.Context, body ExamplepbABitOfEverythingServiceUpdateBody, uuidName string) (interface{}, *http.Response, error) {
	var (
...
func (a *ABitOfEverythingApiService) ABitOfEverythingServiceUpdateBook(ctx context.Context, body V1BookNameBody, bookName string, localVarOptionals *ABitOfEverythingApiABitOfEverythingServiceUpdateBookOpts) (ExamplepbBook, *http.Response, error) {
	var (
...
ABitOfEverythingApiService
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body A bit of everything  Intentionally complicated message type to cover many features of Protobuf.
 * @param uuidName
...
func (a *ABitOfEverythingApiService) ABitOfEverythingServiceUpdateV2(ctx context.Context, body ABitOfEverything, uuidName string, localVarOptionals *ABitOfEverythingApiABitOfEverythingServiceUpdateV2Opts) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return interface{}
*/
func (a *ABitOfEverythingApiService) ABitOfEverythingServiceUpdateV22(ctx context.Context, body ABitOfEverything2, uuidName string) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return interface{}
*/
func (a *ABitOfEverythingApiService) ABitOfEverythingServiceUpdateV23(ctx context.Context, body ABitOfEverythingServiceUpdateV2Body, uuidName string) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
