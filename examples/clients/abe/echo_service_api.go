...
/* EchoServiceApiService Summary: Echo rpc
 Description Echo
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param value 
 @return SubStringMessage*/
func (a *EchoServiceApiService) Echo(ctx context.Context, value string) (SubStringMessage,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param body 
 @return SubStringMessage*/
func (a *EchoServiceApiService) Echo2(ctx context.Context, body string) (SubStringMessage,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "value" (string) 
 @return SubStringMessage*/
func (a *EchoServiceApiService) Echo3(ctx context.Context, localVarOptionals map[string]interface{}) (SubStringMessage,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
