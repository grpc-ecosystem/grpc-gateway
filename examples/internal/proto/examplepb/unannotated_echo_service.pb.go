...
func (*UnannotatedSimpleMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_a57876726ab5dd80, []int{0}
}
...
func init() {
	proto.RegisterFile("examples/proto/examplepb/unannotated_echo_service.proto", fileDescriptor_a57876726ab5dd80)
}

var fileDescriptor_a57876726ab5dd80 = []byte{
