...
func (PathEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_path_enum_a83081a8771b5cad, []int{0}
}
...
func (MessagePathEnum_NestedPathEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_path_enum_a83081a8771b5cad, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("examples/proto/pathenum/path_enum.proto", fileDescriptor_path_enum_a83081a8771b5cad)
}

var fileDescriptor_path_enum_a83081a8771b5cad = []byte{
