...
var (
	...
	ignoreProtoComments            = flag.Bool("ignore_proto_comments", false, "if set, all protofile comments are excluded from output")
...
func main() {
	...
	reg.SetIgnoreProtoComments(*ignoreProtoComments)
