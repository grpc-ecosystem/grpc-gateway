...
http_archive(
    ...
    urls = ["https://github.com/protocolbuffers/protobuf/archive/v35.0.tar.gz"],
)

http_archive(
    name = "googleapis",
    sha256 = "3707f240c7fd63970ba54ea3eaf5dc4a7526673a86f4dde433bed2fa8abfb6c3",
    strip_prefix = "googleapis-3640590d319b5626357d5aa68a9b5a76a71bacd2",
    urls = [
        "https://github.com/googleapis/googleapis/archive/3640590d319b5626357d5aa68a9b5a76a71bacd2.zip",
    ],
)
...
http_archive(
    name = "bazel_gazelle",
    sha256 = "c5dcaaf4fdaf724be8d9ef8446e23ed17c1b20db413c8b6a2a7d07cc9d4cf3f4",
    urls = [
        "https://mirror.bazel.build/github.com/bazelbuild/bazel-gazelle/releases/download/v0.51.1/bazel-gazelle-v0.51.1.tar.gz",
        "https://github.com/bazelbuild/bazel-gazelle/releases/download/v0.51.1/bazel-gazelle-v0.51.1.tar.gz",
    ],
)
