...
http_archive(
    ...
    strip_prefix = "googleapis-9415ba048aa587b1b2df2b96fc00aa009c831597",
    urls = [
        "https://github.com/googleapis/googleapis/archive/9415ba048aa587b1b2df2b96fc00aa009c831597.zip",
    ],
)
