...
func (*EmptyProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_53e866bab3f236bf, []int{0}
}
...
func (*NonEmptyProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_53e866bab3f236bf, []int{1}
}
...
func (*UnaryProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_53e866bab3f236bf, []int{2}
}
...
func (*NestedProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_53e866bab3f236bf, []int{3}
}
...
func (*SingleNestedProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_53e866bab3f236bf, []int{4}
}
...
func init() {
	proto.RegisterFile("examples/proto/examplepb/flow_combination.proto", fileDescriptor_53e866bab3f236bf)
}

var fileDescriptor_53e866bab3f236bf = []byte{
