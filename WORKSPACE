...
http_archive(
    ...
    strip_prefix = "googleapis-2233f63baf69c2a481f30180045fcf036242781d",
    urls = [
        "https://github.com/googleapis/googleapis/archive/2233f63baf69c2a481f30180045fcf036242781d.zip",
    ],
)
